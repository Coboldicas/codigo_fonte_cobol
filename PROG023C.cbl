      ...
      * DATA.......: 29/09/2025
      * DESCRICAO..: CONTROLE DE ESTOQUE - GERACAO DE LOG
...
>>>>>>> cb85f5b (Adiciona estrutura do projeto COBOL Dicas)
      ...
      *----------------------------------------------------------------*
           ...
           IF WRK-ENCONTROU            EQUAL 'S'
              ...
              MOVE TAB-QTDE(WRK-IND1)  TO FDS-QTDE-PROD-ANT
              MOVE TAB-VALOR(WRK-IND1) TO FDS-VALOR-PROD-ANT
   
              PERFORM 0033-VALIDAR-QTDE UNTIL WRK-VAL-QTDE EQUAL 'S'
              ADD WRK-QTDE-PRODUTO     TO TAB-QTDE(WRK-IND1)
              MOVE TAB-QTDE(WRK-IND1)  TO FDS-QTDE-PROD-ATU
      ...
      *----------------------------------------------------------------*
           ...
           IF WRK-ENCONTROU            EQUAL 'S'
              ...
              MOVE TAB-QTDE(WRK-IND1)  TO FDS-QTDE-PROD-ANT
              MOVE TAB-VALOR(WRK-IND1) TO FDS-VALOR-PROD-ATU
